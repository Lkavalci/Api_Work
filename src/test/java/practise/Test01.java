...
// dönen status code'un 200 oldugu ve response message bilgisinin "Success" oldugu dogrulanmali
    ...
    // taze token aldık ( postman swagger dökümanı) manual>>> sonrasında methoda bağladık
       // manuel olarak Token'i taze almalıyız.(postman swagger dökümanı) bunu metoda cevirdik bu yuzden.
        ...
        Response response = given()
                ...
                .headers(
                        "Authorization",
                        "Bearer "+ token, // bearer den sonraki boşluk önemli
                        "Content-Type",
                        ContentType.JSON,
                        "Accept",
                        ContentType.JSON
        ...
        // gözümüzle gördük ki her şey çalışıyor
