...
// Soft assert istediği için pom xml'e Test NG dependiys yukledik.
    /*
...
"message": "Successfully! Record has been fetched."
    ...
    public void get01() {
        ...
        softAssert.assertEquals(respJP.get("profile_image"), expData.getJSONObject("data").get("profile_image"));
